                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="cart-total item">Итоговая стоимость</th>
                                        <th class="cart-total item">Метод оплаты</th>
                                        <th class="cart-description item">Дата заказа</th>
                                        <th class="cart-total last-item">Действие</th>
                                    </tr>
                                </thead><!-- /thead -->
...
?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Отследить заказ">
                                                Отследить
                                            </a>
                                        </td>
                                    </tr>
<?php $cnt=$cnt+1;} } else { ?>
                                    <tr><td colspan="8">ID заказа или зарегистрированный email недействителен</td></tr>
<?php } ?>
                                </tbody><!-- /tbody -->
                            </table><!-- /table -->
                        </form>
...
<!-- Для демонстрационных целей – можно удалить в производственной версии : Конец -->
</body>
</html>
