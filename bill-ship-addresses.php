...
header('location:.php');
	...
	// код для обновления платежного адреса
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Платежный адрес был обновлен');</script>";
		}
	}
...
<html lang="en">
	<head>
		...
		<!-- Только для демонстрационных целей. Должен быть удален в производственной среде -->
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Платежный адрес<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Платежный штат<span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Платежный город<span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Платежный индекс<span>*</span></label>
...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Штат доставки<span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Почтовый индекс доставки<span>*</span></label>
...
<?php include('includes/footer.php');?>
	...
	<!-- Для демонстрационных целей – может быть удалено в производственной среде -->
