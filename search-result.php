...
// Код для добавления товара в список желаемого
...
<head>
	...
	<!-- Для демонстрационных целей. Удалить в продакшене -->
	...
	<!-- Для демонстрационных целей. Удалить в продакшене : КОНЕЦ -->
	...
	<!-- Поддержка элементов HTML5 и медиа-запросов для IE8 : HTML5 shim и Respond.js -->
	<!--[if lt IE 9]>
													...
													<div class="products">
														<div class="product">
															<div class="product-image">
																<div class="image">
																	<a href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>"><img src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>" style="object-fit: cover" alt="" width="200" height="300"></a>
																</div><!-- /.image -->
															</div><!-- /.product-image -->
