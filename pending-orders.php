...
<html lang="ru">
	<head>
	    ...
	    <title>История неподтвержденных заказов</title>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total">Итоговая сумма</th>
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Перейти к оплате</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Результаты не найдены</h4></td>
</tr>
<?php } ?>
