...
<div class="control-group">
<label class="control-label" for="basicinput">Цена после скидки (цена продажи)</label>
<div class="controls">
<input type="text" name="productprice" placeholder="Введите цену продукта" class="span8 tip" required>
</div>
</div>
