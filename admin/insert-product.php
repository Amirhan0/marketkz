...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $productprice = $_POST['productpriceDollar'];
        ...
        $sql = mysqli_query($con, "INSERT INTO products (category, subCategory, productName, productCompany, productPrice, productDescription, shippingCharge, productAvailability, productImage1, productImage2, productImage3/*, productPriceBeforeDiscount*/) 
        ...
        $_SESSION['msg'] = "Продукт успешно добавлен!";
    }
?>
    <!DOCTYPE html>
    <html lang="ru">
    ...
    <head>
        ...
        <title>Админ | Добавить продукт</title>
                                ...
                                <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="productName" placeholder="Введите название продукта" class="span8 tip" required>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Компания производителя</label>
                                            <div class="controls">
                                                <input type="text" name="productCompany" placeholder="Введите название компании производителя" class="span8 tip" required>
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="productpricebd" placeholder="Введите цену продукта" class="span8 tip" required>
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="productpriceDollar" id="productpriceDollar" placeholder="Введите цену продукта в долларах" class="span8 tip" oninput="convertToTenge()" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="productDescription" placeholder="Введите описание продукта" rows="6" class="span8 tip"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Доступность продукта</label>
                                            <div class="controls">
