...
if(strlen($_SESSION['alogin']) == 0) {    
    ...
    date_default_timezone_set('Asia/Almaty'); // Изменить в соответствии с вашим часовым поясом
    $currentTime = date('d-m-Y h:i:s A', time());

    if(isset($_GET['del'])) {
        mysqli_query($con, "DELETE FROM products WHERE id = '".$_GET['id']."'");
        $_SESSION['delmsg'] = "Продукт удалён!";
    }
?>
<!DOCTYPE html>
<html lang="ru">
    ...
    ?>                                    
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="manage-products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Вы уверены, что хотите удалить?')"><i class="icon-remove-sign"></i></a>
                        </td>
                    </tr>
    <?php 
    $cnt = $cnt + 1; 
