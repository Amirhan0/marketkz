...
if (strlen($_SESSION['alogin']) == 0) {    
    ...
    $pid = intval($_GET['id']); // идентификатор продукта
    ...
    if (isset($_POST['submit'])) {
        ...
        $_SESSION['msg'] = "Изображение продукта успешно обновлено!!";
    }
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <title>Админ | Обновление изображения продукта</title>
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Обновление изображения продукта 2</h3>
                            </div>
                            <div class="module-body">
                                ...
                                <?php if (isset($_POST['submit'])) { ?>
                                    <div class="alert alert-success">
                                        ...
                                        <strong>Молодец!</strong> <?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg'] = "");?>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Текущее изображение продукта 2</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Новое изображение продукта 2</label>
                                    <div class="controls">
