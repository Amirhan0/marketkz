...
<head>
    ...
    <title>Admin| Обновить изображение продукта</title>
                ...
                <div class="content">
                    ...
                    <div class="module">
                        <div class="module-head">
                            <h3>Обновить изображение продукта 1</h3>
                        </div>
                        <div class="module-body">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="basicinput">Текущее изображение продукта 1</label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="basicinput">Новое изображение продукта 1</label>
                                <div class="controls">
