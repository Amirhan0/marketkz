...
if(isset($_POST['submit']))
{
    ...
    $_SESSION['msg']="Подкатегория обновлена!!";
...
<head>
    ...
    <title>Админ| Редактировать Подкатегорию</title>
...
<div class="controls">
<input type="text" placeholder="Введите название подкатегории" name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
