    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>Отслеживание ваших заказов</li>
            </ul>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <span class="title-tag inner-top-vs">
                        Пожалуйста, введите ваш идентификатор заказа в поле ниже и нажмите Enter. Этот идентификатор был выдан вам в чеке и в подтверждающем электронном письме, которое вы должны были получить.
                    </span>
                    <form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
                        <div class="form-group">
                            <label class="info-title" for="exampleOrderId1">Идентификатор заказа</label>
                            <input type="text" class="form-control unicase-form-control text-input" name="orderid" id="exampleOrderId1">
                        </div>
                        <div class="form-group">
                            <label class="info-title" for="exampleBillingEmail1">Зарегистрированный Email</label>
