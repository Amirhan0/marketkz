...
if(isset($_POST['change'])) {
    ...
    // Проверка наличия пользователя с указанным email и контактным номером
    ...
    if($num > 0) {
        ...
        // Если email или контактный номер неверны
        $extra = "forgot-password.php";
        $host = $_SERVER['HTTP_HOST'];
        $uri = rtrim(dirname($_SERVER['PHP_SELF']), '/\\');
        header("location:http://$host$uri/$extra");
        $_SESSION['errmsg'] = "Неверный email или контактный номер";
        exit();
    }
}
?>
...
<head>
    ...
    <title>OPTO MARKET | Восстановление пароля</title>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 sign-in">
                    ...
                    <form class="register-form outer-top-xs" name="register" method="post" onsubmit="return valid();">
                        ...
                        <div class="form-group">
                            <label class="info-title" for="confirmpassword">Подтвердите пароль <span>*</span></label>
                            <input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" required >
                        </div>
                        <button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Изменить</button>
                    </form>                    
                </div>
                <!-- Sign-in -->
...
<!-- Для демонстрационных целей – можно удалить на продакшене : End -->
